link:https://github.com/dev-centr/msi-generator[image:https://img.shields.io/badge/repo-GitHub-24292e?style=flat[Repository]]
...
[source,bash]
----
./msi-installer-generator --name="MyApp" --id="com.example.myapp" --version="1.0.0.0" --exe="bin/myapp.exe" --output="myapp.msix"
----
